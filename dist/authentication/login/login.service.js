...
import { insertOtp, findOtp, removeExpiredOtp, } from "../../model/otps.model.js";
import { loginValidation, mobileValidation, otpValidation, } from "../../validation/loginValidation.js";
...
export const loginUser = async (userCredential) => {
    ...
    const token = jwt.sign({ userPermissions }, process.env.JWT_SECRET || "secret key", { expiresIn: "1h" });
    return { token };
};
